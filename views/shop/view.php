                            ...
                            <div class="item__preview-img">
                                <div class="item__preview-slider">
                                    <div class="prev-slide">
                                        <img src="<?php echo $product['image']; ?>" alt="Preview Image">
                                    </div>
                                    <div class="prev-slide">
                                    ...
                                    <div class="panel-group accordion" role="tablist" id="accordion">
                                        ...
                                        <div class="panel accordion__single" id="panel-two">
                                            ...
                                            <div id="collapse2" class="panel-collapse collapse"
                                                 aria-labelledby="panel-two" data-parent="#accordion">
                                                <div class="panel-body">
                                                    <p>Nunc placerat mi id nisi interdum mollis. Praesent pharetra,
                                                        justo ut
                                                        sceleris que the mattis, leo quam aliquet congue placerat mi id
                                        ...
                                        <div class="panel accordion__single" id="panel-four">
                                            ...
                                            <div id="collapse4" class="panel-collapse collapse"
                                                 aria-labelledby="panel-four" data-parent="#accordion">
                                                <div class="panel-body">
                                                    <p>Nunc placerat mi id nisi interdum mollis. Praesent pharetra,
                                                        justo ut
                                                        sceleris que the mattis, leo quam aliquet congue placerat mi id
                                        ...
                                        <div class="panel accordion__single" id="panel-five">
                                            ...
                                            <div id="collapse5" class="panel-collapse collapse"
                                                 aria-labelledby="panel-five" data-parent="#accordion">
                                                <div class="panel-body">
                                                    <p>Nunc placerat mi id nisi interdum mollis. Praesent pharetra,
                                                        justo ut
                                                        sceleris que the mattis, leo quam aliquet congue placerat mi id
                                        ...
                                        <div class="panel accordion__single" id="panel-six">
                                            ...
                                            <div id="collapse6" class="panel-collapse collapse"
                                                 aria-labelledby="panel-six" data-parent="#accordion">
                                                <div class="panel-body">
                                                    <p>Nunc placerat mi id nisi interdum mollis. Praesent pharetra,
                                                        justo ut
                                                        sceleris que the mattis, leo quam aliquet congue placerat mi id
                ...
                <aside class="sidebar sidebar--single-product">
                    ...
                    <div class="sidebar-card card--product-infos">
                        ...
                        <ul class="infos">
                            ...
                            foreach ($chars as $char_key => $char_value) { ?>
                                <li>
                                    <p class="data-label"><?php echo $char_key; ?></p>
                                    <p class="info"><?php echo $char_value; ?></p>
                                </li>
                            <?php } ?>
...
<section class="more_product_area p-top-105 p-bottom-75">
    <div class="container">
        <div class="row">
            ...
            <?php
            $products = \app\models\db\Products::find()
...
<!-- Modal -->
<div class="modal fade" id="add-to-cart" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
