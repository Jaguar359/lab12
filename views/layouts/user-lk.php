...
<?php $this->beginPage() ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="dashboard_menu">
                            <li class="active">
                                <a href="index.php?r=lk"><span class="lnr icon-home"></span>В начало</a>
                            </li>
                            <li>
                                <a href="index.php?r=lk/settings"><span class="lnr icon-settings"></span>Настройки</a>
                            </li>
                            <li>
                                <a href="index.php?r=lk/my-orders"><span class="lnr icon-basket"></span>Мои заказы</a>
                            </li>
    ...
    <script>
        $(".send-money-btn").click(function (e) {
            e.preventDefault();

            var currency = $('.currency').val();
            var sum = $('.sum').val();
            var cbnum = $('.cb-num').val();

            $.get("index.php?r=payment/send-money", {currency, sum, cbnum}, function (res) {
                console.log(res);
            });
        });
    </script>
