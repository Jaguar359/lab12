                                        ...
                                        <li class="has_dropdown">
                                            ...
                                            <div class="dropdown notification--dropdown">
                                                ...
                                                <div class="notifications_module">
                                                    ...
                                                    <?php
                                                    $all_notification = \app\models\db\Notification::find()
                                                    ...
                                                    foreach ($all_notification as $notification) {
                                                        ...
                                                        <div class="notification">
                                                            <div class="notification__info">
                                                                ...
                                                                <div class="info">
                                                                    <p>
                                                                        <span><?php echo $notification['theme']; ?></span>
                                                                        <br>
                                                                        <?php echo $notification['message']; ?>
                                                                    </p>
                                                                    <p class="time"><?php echo date('d.m.Y H:i:s',
                                                                            $notification['datetime']); ?></p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <?php if (count($all_notification) > 0) { ?>
                                                        <div class="text-center m-top-30 p-left-20 p-right-20">
                                                            <a href="#!"
                                                               class="btn btn-primary btn-md btn-block check-notification">
                                                                Пометить все прочитанным
                                                            </a>
                                                        </div>
                                                    <?php } else {
                                                        echo '<div style="padding: 10px 25px">Оповещений нет</div>';
                                                    } ?>
                                                </div>
                                            </div>
                                        </li>
